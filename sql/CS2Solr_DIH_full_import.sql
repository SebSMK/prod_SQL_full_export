...
concepttermgroup.termqualifier                                          AS object_type_en,
...
/* - object -*/
        ...
        LEFT JOIN(
                SELECT
                 objectid,
                 string_agg(sub_proddate.production_dates,';-;') AS production_dates,
                 MIN(datesmkearliestscalarvalue) AS datesmkearliestscalarvalue,
                 MAX(datesmklatestscalarvalue) AS datesmklatestscalarvalue
